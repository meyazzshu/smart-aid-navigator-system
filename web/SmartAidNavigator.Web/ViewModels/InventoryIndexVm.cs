...
public class InventoryCategoryFilterVm
{
    public int CategoryId { get; set; }
    public string CategoryName { get; set; } = "";
}

public class ShelterAddStockVm
{
    public string ShelterName { get; set; } = "";

    public string? Note { get; set; }

    public List<ShelterAddStockItemVm> Items { get; set; } = new();
}

public class ShelterAddStockItemVm
{
    public long ItemId { get; set; }
